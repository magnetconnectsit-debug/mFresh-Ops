...
// import 'package:mfresh_ops/modules/booking/views/widgets/search_bar_tool.dart';
import 'package:mfresh_ops/modules/booking/views/widgets/unit_card.dart';
...
class BookingUnitSelectionScreen extends StatefulWidget {
  const BookingUnitSelectionScreen({super.key});

  @override
  State<BookingUnitSelectionScreen> createState() => _BookingUnitSelectionScreenState();
}

class _BookingUnitSelectionScreenState extends State<BookingUnitSelectionScreen> {
  final controller = Get.put(BookingUnitSelectionController());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(() {
                        ...
                        if (controller.allUnitsList.isEmpty) {
                          return const Center(
                        ...
                        return GridView.builder(
                          ...
                          itemCount: controller.allUnitsList.length,
                          itemBuilder: (context, index) {
                            final unit =
                                controller.allUnitsList[index];
                            return UnitCard(
    ...
    if (cameraCount > 0) {
              ...
              MobileScanner(
                ...
                onDetect: (capture) async {
                  ...
                  if (barcodes.isNotEmpty && barcodes.first.rawValue != null) {
                    ...
                    final result = await controller.handleScannedCode(
                      code,
                    );
      ...
      try {
        ...
        if (data['Response']?['ScannedValue'] != null &&
          ...
          final apiResult = await controller.handleScannedCode(
            scannedValue,
          );
          if (apiResult != null) {
            _showAccessResult(
