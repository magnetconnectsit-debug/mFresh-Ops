...
class SupportTicketsScreen extends StatelessWidget {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Skeletonizer(
                                    ...
                                    child: Text(
                                      "Total Tickets: ${controller.totalTickets
                                          .value}",
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<QuickFilter>(
                            ...
                            hint: Row(
                              children: [
                                Icon(Icons.bookmark_border, size: 12.r,
                            ...
                            icon: Icon(Icons.keyboard_arrow_down, size: 14.r,
                                color: const Color(0xFF5B7FFF)),
                            items: filters.map((f) =>
                                DropdownMenuItem(
                                  value: f,
                            ...
                            onChanged: (val) {
                              if (val != null) controller.applyQuickFilter(val);
                            },
                          ),
                        ),
                      ),
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Save Filter', style: AppTextStyle.style_16_700(
                      color: AppColors.grey900)),
                  InkWell(onTap: () => Get.back(),
                      child: const Icon(
                          Icons.close, color: Colors.grey, size: 20)),
                ],
              ),
  ...
  Widget _buildSingleDropdown<T>(String label,
      T? value,
                  ...
                  Obx(
                        ...
                        _buildBulkDropdownRow<SupportSubCategory>(
                          ...
                          controller.bulkSubCategories
                              ...
                              .toList(),
                              (val) =>
                          controller.bulkSelectedSubCategory.value = val,
                        ),
                  ),
                  SizedBox(height: 10.h),
  ...
  Widget _buildBulkDropdownRow<T>(String label,
      RxBool isEnabled,
      Rxn<T> selectedValue,
