              ...
              GridView(
                ...
                children: [
                  ...
                  MultiSelectDropdownWidget<SupportCategory>(
                    label: "Category",
                    isSingleSelect: true,
                    selectedValues: controller.selectedCategories.isNotEmpty ? {controller.selectedCategories.first} : {},
                    ...
                    onChanged: (values) {
                      if (values.isNotEmpty) {
                        controller.selectedCategories.assignAll([values.first]);
                        controller.fetchSubCategories(values.first.categoryId);
                      } else {
                  ...
                  MultiSelectDropdownWidget<SupportSubCategory>(
                    label: "Sub Category",
                    isSingleSelect: true,
                    selectedValues: controller.selectedSubCategory.value != null ? {controller.selectedSubCategory.value!} : {},
                    items: controller.subCategoryOptions
                        ...
                        .toList(),
                    onChanged: (values) {
                      controller.selectedSubCategory.value = values.isNotEmpty ? values.first : null;
                      controller.applyFilters();
                    },
                  ),
                  // endregion
