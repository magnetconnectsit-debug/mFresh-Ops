      ...
      children: [
        Flexible(
          child: _buildOutlinedButton(
            'Delete',
            () => controller.deleteTaskInstance(task),
        ...
        Flexible(
          child: _buildButton(
            ...
            () => controller.submitTask(task, isUpdate: true),
            loading: controller.isLoading.value,
          ),
        ),
        SizedBox(width: 4.w),
      ...
      children: [
        Flexible(
          child: _buildButton(
            'Reject',
            const Color(0xFFFF5252),
            () => controller.rejectTask(task.taskInstanceId),
            loading: controller.isLoading.value,
          ),
        ),
        SizedBox(width: 12.w),
        Flexible(
          child: _buildButton(
            ...
            () => controller.approveTask(task.taskInstanceId),
            loading: controller.isLoading.value,
          ),
        ),
      ],
      ...
      child: ElevatedButton(
        ...
        child: loading
            ? SizedBox(
                width: 14.r,
                height: 14.r,
                child: const CustomAppLoader(size: 14, color: AppColors.white),
              )
            : FittedBox(
